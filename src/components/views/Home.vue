...
const skills = ref([{
  ...
  {
    title: 'Linux',
    color: 'mdui-color-blue-grey-900',
  },
  {
    title: 'ChatGPT',
    color: 'mdui-color-blue-grey',
  },
]);
...
<template>
    ...
    <div class="mdui-card">
      <div class="mdui-col-xl-6 mdui-col-lg-6 mdui-col-md-6 mdui-col-sm-12 mdui-m-y-2">
        <div class="mdui-card-content">
          ...
          <div class="mdui-card-content">
            <div v-for="skill in skills" :key="skill.title" class="mdui-chip" :class="skill.color">
      ...
      <div class="mdui-col-xl-6 mdui-col-lg-6 mdui-col-md-6 mdui-col-sm-12 mdui-m-y-2">
        <div class="mdui-card-content">
          <div class="mdui-card-primary-title">Tomoriゞ</div>
          <p><a href="https://beian.miit.gov.cn/" target="_blank" rel="external nofollow noopener">鲁ICP备2023052135号-4</a></p>
          <div class="mdui-typo">
            <iframe frameborder="no" border="0" marginwidth="0" marginheight="0" width=100% height=100 src="//music.163.com/outchain/player?type=2&id=456175178&auto=1&height=66"></iframe>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="mdui-col-xs-12">
    ...
    <div class="mdui-row-xs-1 mdui-row-sm-2 mdui-row-md-2 mdui-row-lg-4 mdui-row-xl-4 mdui-m-y-2">
